...
;; Seed DB
(defn insert-tutors! [] (doseq [t d/tutors] (create-tutor! t)))
(defn insert-availabilities! [] (doseq [a d/availabilities] (create-availability! a)))
(defn insert-speaking-sessions! [] (doseq [s d/sessions] (create-speaking-session! s)))
